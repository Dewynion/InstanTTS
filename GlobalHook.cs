...
// Pulled directly from https://stackoverflow.com/a/57710850 because I had absolutely no idea how to do it.
// Thank you to https://stackoverflow.com/users/2326753/c4d for the edited version 
// of https://stackoverflow.com/users/212746/siarhei-kuchuk 's implementation.
    ...
    class GlobalKeyboardHook : IDisposable
    {
        ...
        public IntPtr LowLevelKeyboardProc(int nCode, IntPtr wParam, IntPtr lParam)
        {
            ...
            if (Enum.IsDefined(typeof(KeyboardState), wparamTyped))
            {
                ...
                var key = KeyInterop.KeyFromVirtualKey(p.VirtualCode);
